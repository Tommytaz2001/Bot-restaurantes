        ...
        productos: {
          ...
          items: {
            ...
            properties: {
              ...
              opcion: { type: 'string', description: 'Opción o modificación del producto. Puede ser variante del menú (ej: "BBQ", "Chipotle dulce") o personalización del cliente (ej: "sin cebolla", "extra queso", "término medio"). Si tiene variante Y modificación, combínalas con coma (ej: "BBQ, sin cebolla").' },
            },
        ...
        productos_nuevos: {
          ...
          items: {
            ...
            properties: {
              ...
              cantidad: { type: 'number' },
              precio_unitario: { type: 'number' },
              opcion: { type: 'string', description: 'Opción o modificación del producto. Puede ser variante del menú (ej: "BBQ") o personalización (ej: "sin cebolla", "extra queso"). Si tiene variante Y modificación, combínalas con coma (ej: "BBQ, sin cebolla").' },
            },
            required: ['nombre', 'cantidad', 'precio_unitario'],
          },
        },
